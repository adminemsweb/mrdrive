<section class="catalog-hero">
    ...
    <p>Conheça os modelos disponíveis, aplicações recomendadas e detalhes técnicos das linhas MRD600 e MRD700.</p>
    <div class="actions">
        <a class="btn btn-whatsapp" href="/#contato"><span class="wa-icon" aria-hidden="true">W</span>Solicitar orçamento</a>
        <?php if ($documents): ?>
            <a class="btn btn-secondary" href="<?= upload_url($documents[0]['file_path']) ?>" target="_blank">Baixar catálogo geral</a>
        <?php endif; ?>
    </div>
</section>
...
<section class="section catalog-page">
    ...
    <?php $catalogProducts = [
        ...
        [
            'name' => 'MRD700',
            'model_code' => 'MRD700',
            'short_description' => 'Linha vetorial de alto desempenho com expansão PLC, comunicação industrial e automação.',
            'power' => 'Sob consulta',
        ...
        [
            ...
            'short_description' => 'Versão lavável para água, poeira e ambientes severos, com STO, PID, PLC e protocolos industriais.',
    ...
    <div class="catalog-grid catalog-grid-page">
        ...
        <?php if (false): ?>
            <article class="empty-card">
                ...
                <p>Adicione produtos no painel administrativo para preencher o catálogo.</p>
